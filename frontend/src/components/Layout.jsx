...
const links = [
  ...
  { to: '/staff', label: 'Staff', icon: FiUserCheck, roles: ['super_admin', 'headteacher', 'hr_officer', 'accountant', 'auditor'] },
  ...
  { to: '/attendance', label: 'Attendance', icon: FiCalendar, roles: ['super_admin', 'hr_officer', 'headteacher', 'teacher'] },
  { to: '/leave', label: 'Leave', icon: FiClipboard, roles: ['super_admin', 'hr_officer', 'headteacher', 'teacher'] },
  { to: '/payroll', label: 'Payroll', icon: FiBarChart2, roles: ['super_admin', 'headteacher', 'hr_officer', 'accountant', 'auditor'] },
  { to: '/anomalies', label: 'Anomalies', icon: FiAlertTriangle, roles: ['super_admin', 'headteacher', 'hr_officer', 'accountant', 'auditor'] },
